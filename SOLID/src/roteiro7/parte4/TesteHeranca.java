...
public class TesteHeranca {
    public static void main(String[] args) {
        ...
        Component radiobutton = new Component("RadioButton"); // Criando um GridContainer para adicionar os elementos
        
        GridContainer c1 = new GridContainer(2, 2);
        ...
        System.out.println(" ** "); // Criando um FlowContainer para adicionar os elementos
        FlowContainer c2 = new FlowContainer();
        ...
        Container c4 = new FlowContainer(new BordaPontilhada());
